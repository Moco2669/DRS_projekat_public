...
export default function MainPage() {
  ...
  const handleOrderClick = (productId, price, currency) => {
    ...
    const confirmationMessage = `Are you sure you want to place an order for ${price} ${currency}?`;
      ...
      <div className="flex justify-between">
        <div className="w-1/4 ml-8">
          ...
          <div>
            ...
            {!isUserAdmin && isUserVerified && <div className="my-2 p-4 bg-gray-800 rounded-lg">
